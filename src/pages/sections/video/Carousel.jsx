...
export default function Carousel() {
    ...
    return (
        <>
            <div id="videoPageCarousel" className="carousel carousel-fade full-page-carousel slide container-fluid p-relative" data-ride="carousel" data-interval="4000">
                <ol className="carousel-indicators">
                    <li data-target="#videoPageCarousel" data-slide-to="0"></li>
                    <li data-target="#videoPageCarousel" data-slide-to="1"></li>
                    <li data-target="#videoPageCarousel" data-slide-to="2"></li>
                    <li data-target="#videoPageCarousel" data-slide-to="3"></li>
                    <li data-target="#videoPageCarousel" data-slide-to="4"></li>
                    <li data-target="#videoPageCarousel" data-slide-to="5"></li>
                    <li data-target="#videoPageCarousel" data-slide-to="6"></li>
                    <li data-target="#videoPageCarousel" data-slide-to="7"></li>
                </ol>
